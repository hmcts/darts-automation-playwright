...
Feature: Admin Search
  ...
  # TODO (DT): removed the last 2 steps as that hides the files and cannot be done on every run
  ...
  Scenario: Hearings search results
    ...
    And I set "Enter a date from" to "20/06/2024"
    And I set "Enter a date to" to "24/06/2024"
    And I press the "Search" button
