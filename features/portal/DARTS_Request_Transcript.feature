...
Feature: Request Transcript
  ...
  Scenario: Request Transcription, Specified Times with Event Checkboxes
    ...
    And I see "Search for a case2" on the page
    ...
    And I see "DefC {{seq}}-9" in summary row for "Defendant(s)"
    ...
    And I see "C{{seq}}002" in summary row for "Case ID"
    And I see "Harrow Crown Court" in summary row for "Courthouse"
    And I see "{{upper-case-JudgeC {{seq}}-9}}" in summary row for "Judge(s)"
    And I see "DefC {{seq}}-9" in summary row for "Defendant(s)"
    And I see "{{displaydate}}" in summary row for "Hearing date"
    And I see "Specified Times" in summary row for "Request type"
    And I see "Overnight" in summary row for "Urgency"
    And I see "Requesting transcript Specified Times for one minute of audio selected via event checkboxes." in summary row for "Instructions"
    ...
    And I click on the "Your transcripts" link
    Then I see "C{{seq}}002" in summary row for "Complete"
    ...
    Then I see "Requesting transcript Specified Times for one minute of audio selected via event checkboxes." in summary row for "Instructions"
  ...
  Scenario: Request Transcription, Court Log by Manually Entering Time
    ...
    And I press the "Search" button
    When I click on the "C{{seq}}003" link
    ...
    And I see "Harrow Crown Court" in summary row for "Courthouse"
    And I see "DefC {{seq}}-10" in summary row for "Defendant(s)"
    And I see "{{displaydate}}" in summary row for "Hearing date"
    ...
    And I see "C{{seq}}003" in summary row for "Case ID"
    And I see "Harrow Crown Court" in summary row for "Courthouse"
    And I see "{{upper-case-JudgeC {{seq}}-10}}" in summary row for "Judge(s)"
    And I see "DefC {{seq}}-10" in summary row for "Defendant(s)"
    And I see "{{displaydate}}" in summary row for "Hearing date"
    And I see "Court Log" in summary row for "Request type"
    And I see "Overnight" in summary row for "Urgency"
    And I see "Requesting transcript Court Log for one minute of audio selected via manually entering time." in summary row for "Instructions"
    And I see "Yes" in summary row for "Judge approval"
    ...
    Then I see "Requesting transcript Court Log for one minute of audio selected via manually entering time." in summary row for "Instructions"
    And I see "Complete" on the page
  ...
  Scenario: Request two transcriptions, assign to me and attach transcript, complete and multiple delete
    ...
    Then I see "Approve transcript request" on the page
    And I see "Requesting second transcript Specified Times for one minute of audio, attach transcript directly." in summary row for "Instructions"
  ...
  Scenario: Request Transcription, Rejected by Approver
    ...
    And I see "Harrow Crown Court" in summary row for "Courthouse"
    And I see "DefC {{seq}}-12" in summary row for "Defendant(s)"
    And I see "{{displaydate}}" in summary row for "Hearing date"
    And I see "Court Log" in summary row for "Request type"
    And I see "Overnight" in summary row for "Urgency"
    And I see "Provide any further instructions or comments for the transcriber." on the page
    ...
    And I see "C{{seq}}005" in summary row for "Case ID"
    And I see "Harrow Crown Court" in summary row for "Courthouse"
    And I see "{{upper-case-JudgeC {{seq}}-12}}" in summary row for "Judge(s)"
    And I see "DefC {{seq}}-12" in summary row for "Defendant(s)"
    And I see "{{displaydate}}" in summary row for "Hearing date"
    And I see "Court Log" in summary row for "Request type"
    And I see "Overnight" in summary row for "Urgency"
    And I see "Requesting transcript Court Log for one minute of audio, this will test negative path." in summary row for "Instructions"
    And I see "Yes" in summary row for "Judge approval"
