...
Feature: NEWCASE and UPDCASE using SOAP
  ...
  @DMP-4753
  Scenario: NEWCASE successful from XHIBIT
    ...
    When I call POST SOAP API using soap action "addDocument" and body:
      ...
      <ccm:Case>
      <ccm:CaseNumber>A12345678</ccm:CaseNumber>
      <ccm:Court>
      <cs:CourtHouseType>Crown Court</cs:CourtHouseType>
      <cs:CourtHouseCode CourtHouseShortName="NEWCA">439</cs:CourtHouseCode>
      <cs:CourtHouseName>COURT_HOUSE_NAME</cs:CourtHouseName>
      <cs:CourtHouseAddress>
      <apd:Line>THE LAW COURTS</apd:Line>
      <apd:Line>QUAYSIDE</apd:Line>
      <apd:Line>NEWCASTLE UPON TYNE</apd:Line>
      <apd:PostCode>NE1 2LA</apd:PostCode>
      </cs:CourtHouseAddress>
      <cs:CourtHouseDX>DX 65127 NEWCASTLE-UPON-TYNE 2</cs:CourtHouseDX>
      <cs:CourtHouseTelephone>01912012000</cs:CourtHouseTelephone>
      <cs:CourtHouseFax>01912012001</cs:CourtHouseFax>
      </ccm:Court>
      <ccm:CaseArrivedFrom>
      ...
      <cs:PersonalDetails>
      <cs:Name>
      <apd:CitizenNameForename>FName</apd:CitizenNameForename>
      <apd:CitizenNameForename>FName2</apd:CitizenNameForename>
      <apd:CitizenNameSurname>SurName</apd:CitizenNameSurname>
      </cs:Name>
    ...
    And I select column "cas.cas_id" from table "COURTCASE" where "courthouse_name" = "<courthouse>" and "case_number" = "T{{seq}}610"
    And I see table "COURTCASE" column "case_number" is "T{{seq}}610" where "cas.cas_id" = "{{cas.cas_id}}"

  @DMP-4752
  Scenario: UPDCASE successful from XHIBIT
    Given I authenticate from the "XHIBIT" source system
    When I call POST SOAP API using soap action "addDocument" and body:
      """
      <messageId xmlns="">34567</messageId>
      ...
      """
    Then the API status code is 200
    And I select column "cas.cas_id" from table "COURTCASE" where "courthouse_name" = "<courthouse>" and "case_number" = "T{{seq}}611"
